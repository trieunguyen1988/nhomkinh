...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
		...
		<?php
			wp_link_pages( array(
				'before' => '<div class="page-links">' . __( 'Trang:', 'profitmag' ),
				'after'  => '</div>',
			) );
		?>
	</div><!-- .entry-content -->
	...
	<footer class="entry-footer">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<?php printf( __( '%1$s', 'profitmag' ), $categories_list ); ?>
			</span>
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Bình luận', 'profitmag' ), __( '1 bình luận', 'profitmag' ), __( '% bình luận', 'profitmag' ) ); ?></span>
		<?php endif; ?>
